...
class Model(nn.Module):
    def __init__(self, n_features, batch_size):
        ...
        self.Atten = RTFM_Attention(len_feature=1024)
    ...
    ############## Estimation Distribution for videos###############
        ...
        index_dist= 4
        index_distn = 7
        abnormal_dist_features = calculating_dist(test_type, abnormal_features2, index_dist)
        normal_dist_features = calculating_dist(test_type, normal_features2, index_distn)
        #--------------------------------------------------------------------------------------
        topk=4
